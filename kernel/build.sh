...
gcc $GCC_ARGS $x64_SRC/dev/acpi/aml_nodes.c -o ./bin/aml_nodes.o
...
gcc $GCC_ARGS proc/syscalls/syscall_routectl.c -o ./bin/syscall_routectl.o
...
gcc $GCC_ARGS proc/syscalls/syscall_sysinfo.c -o ./bin/syscall_sysinfo.o
gcc $GCC_ARGS proc/syscalls/syscall_nodename.c -o ./bin/syscall_nodename.o
...
gcc $GCC_ARGS proc/syscalls/syscall_statfs.c -o ./bin/syscall_statfs.o
gcc $GCC_ARGS proc/syscalls/syscall_getrlimit.c -o ./bin/syscall_getrlimit.o
...
gcc $GCC_ARGS proc/nodename.c -o ./bin/nodename.o
...
gcc $GCC_ARGS net/packet/af_packet.c -o ./bin/af_packet.o
gcc $GCC_ARGS net/packet/packet_raw.c -o ./bin/packet_raw.o
