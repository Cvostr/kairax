...
struct kernel_function functions[] = {
    ...
    KFUNCTION(new_net_buffer_in),
    KFUNCTION(net_buffer_add_back),
    KFUNCTION(net_buffer_acquire),
    KFUNCTION(net_buffer_get_buffer_remain_len),
    ...
    KFUNCTION(usb_device_get_product_strings),
    KFUNCTION(usb_device_get_configuration_descriptor),
    KFUNCTION(usb_device_set_configuration),
    KFUNCTION(usb_get_string_descriptor),
    KFUNCTION(usb_send_async_msg),
    KFUNCTION(usb_device_bulk_msg),
    KFUNCTION(usb_set_interface),
    KFUNCTION(usb_clear_endpoint_halt),
    KFUNCTION(usb_parse_configuration_descriptor),
    // filesystems
