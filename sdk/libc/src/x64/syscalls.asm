...
DEFINE_SYSCALL syscall_alarm,       0x25
...
DEFINE_SYSCALL syscall_getsockname, 0x33
DEFINE_SYSCALL syscall_getpeername, 0x34
DEFINE_SYSCALL syscall_socketpair,  0x35
...
DEFINE_SYSCALL syscall_getrlimit,   0x61
...
DEFINE_SYSCALL syscall_getcpu,      0x135
