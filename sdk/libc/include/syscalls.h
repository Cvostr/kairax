...
extern int syscall_statfs(const char *path, void *buf);
extern int syscall_fstatfs(int fd, void *buf);
...
extern long long syscall_abspath(int fd, const char* path, char *buffer, unsigned long long buflen);
