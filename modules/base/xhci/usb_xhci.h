...
#include "dev/bus/usb/usb_descriptors.h"
...
// Completion Codes
#define XHCI_COMPLETION_CODE_INVALID	0
#define XHCI_COMPLETION_CODE_SUCCESS	1
#define XHCI_COMPLETION_CODE_BABBLE		3
#define XHCI_COMPLETION_CODE_TRANSACTION_ERROR	4
#define XHCI_COMPLETION_CODE_TRB_ERROR	5
#define XHCI_COMPLETION_CODE_STALL		6
